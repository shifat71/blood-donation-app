        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900 tracking-tight">Donor Dashboard</h1>
                <p className="text-gray-600 mt-1 text-lg">Manage your profile and help save lives</p>
              </div>
            </div>
          </div>
          ...
          {/* Profile Section */}
          {!profile ? (
            <div className="bg-white rounded-2xl shadow-lg p-10 text-center mb-8 border border-gray-100">
              ...
              <div className="flex justify-between items-center mb-8 pb-6 border-b border-gray-200">
                ...
                {profile && (
                  <button
                    ...
                    disabled={saving}
                    className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-semibold px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
